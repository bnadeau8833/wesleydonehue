...
$gallery_player_attr              = SBY_Display_Elements_Pro::get_element_attribute( 'show_gallery_player', $settings );
...
<div id="sb_youtube_<?php echo esc_attr( preg_replace( "/[^A-Za-z0-9 ]/", '', $feed_id ) ); ?>" <?php echo $feed_classes; ?>  data-feedid="<?php echo esc_attr( $feed_id ); ?>" data-shortcode-atts="<?php echo esc_attr( $shortcode_atts ); ?>" data-cols="<?php echo esc_attr( $cols_setting ); ?>" data-colsmobile="<?php echo esc_attr( $mobile_cols_setting ); ?>" data-num="<?php echo esc_attr( $num_setting ); ?>" data-nummobile="<?php echo esc_attr( $nummobile_setting ); ?>"<?php echo $other_atts . $feed_styles; ?> <?php echo $sby_main_atts ?> >
	<?php
    ...
    <?php if ( $settings['layout'] === 'grid' || $settings['layout'] === 'carousel' ) { include sby_get_feed_template_part( 'cta', $settings ); } ?>
