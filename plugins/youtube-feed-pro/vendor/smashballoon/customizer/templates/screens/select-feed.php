<div v-if="viewsActive.pageScreen == 'selectFeed' && !iscustomizerScreen && !fullScreenLoader" class="sbc-fs">
	<div class="sbc-create-ctn sbc-fs">
		...
		<?php
			include_once CUSTOMIZER_ABSPATH . 'templates/sections/feeds-type.php';
			include_once CUSTOMIZER_ABSPATH . 'templates/sections/select-source.php';
			include_once CUSTOMIZER_ABSPATH . 'templates/sections/select-template.php';
		?>
	</div>
