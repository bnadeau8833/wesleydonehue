<div class="sbc-extensions-pp-ctn sb-fs-boss sbc-center-boss" v-if="viewsActive.extensionsPopupElement != null && viewsActive.extensionsPopupElement != false">
	<div class="sbc-extensions-popup sbc-popup-inside" v-if="viewsActive.extensionsPopupElement != null && viewsActive.extensionsPopupElement != false" :data-getext-view="viewsActive.extensionsPopupElement">
        ...
        <div>
            ...
            <div class="sbc-extpp-bottom sbc-fs">
                ...
                <div class="sbc-extpp-btns sbc-fs">
                    <a class="sbc-extpp-get-btn sbc-btn-orange" :href="extensionsPopup[viewsActive.extensionsPopupElement].buyUrl" target="_blank" class="sbc-fs-link">{{genericText.upgrade}}</a>
