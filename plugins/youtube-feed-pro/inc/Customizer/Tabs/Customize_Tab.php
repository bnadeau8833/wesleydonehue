			...
			'customize_videos'          => array(
				...
				'nested_sections' => array(
					...
					'customize_lightbox'          => array(
						'heading'     => __( 'Lightbox Experience', 'feeds-for-youtube' ),
		...
		$controls = [
			...
			[
				...
				'section' 	=> [
					...
					'separator'			=> 'none',
					'heading' 			=> __( 'Live Stream Countdown (when applicable)', 'feeds-for-youtube' ),
	...
	*/
	private function get_nested_lightbox_experience_controls() {
		return array(
			...
			array(
				'type'          => 'heading',
				'heading'       => __( 'Custom Link Settings', 'feeds-for-youtube' ),
				'condition'     => array( 'cta' => array( 'link' ) ),
				'conditionHide' => true,
			),
			array(
			...
			array(
				...
				'style'         => array( '[id^=sb_youtube_].sb_youtube.sby_palette_custom_' . $this->feed_id . ' .sby_video_title' => 'color:{{value}}!important;' ),
				'stacked'       => 'true',
			),
			array(
				'type'          => 'colorpicker',
