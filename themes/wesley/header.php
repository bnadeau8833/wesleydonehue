...
<head>
<?php
// Google Tag Manager (group field)
$google_tag_manager = get_field('google_tag_manager', 'option');
if ( $google_tag_manager ) :
	$add_gtm	= $google_tag_manager['add_gtm'];
	$gtm_id		= $google_tag_manager['gtm_id'];
	?>
	<!-- Google Tag Manager -->
...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'wesley' ); ?></a>
	...
	if ( is_archive() || is_page() || is_front_page() || is_home() ) {
