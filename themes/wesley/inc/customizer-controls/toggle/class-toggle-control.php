...
if ( ! class_exists( 'Customizer_Toggle_Control' ) ) {
	...
	class Customizer_Toggle_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_style( 'awesome-fyi-toggle', get_template_directory_uri() . '/inc/customizer-controls/toggle/toggle.css', null );
            wp_enqueue_script( 'awesome-fyi-toggle', get_template_directory_uri() . '/inc/customizer-controls/toggle/toggle.js', array( 'jquery' ), false, true ); //for toggle
        }
